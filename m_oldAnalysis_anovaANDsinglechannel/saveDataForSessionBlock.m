...
dataDir = strcat('/home/adamli/paremap/condensed_data/sessions/');
...
%                 data.metaEvents = metaEvents;
                ...
                data.subject = metaEvents(1).subject;
                data.sessionNum = metaEvents(1).sessionNum;
                data.blockNum = metaEvents(1).blocknumber;
                data.originalResponseTimes = [metaEvents.responseTime];
