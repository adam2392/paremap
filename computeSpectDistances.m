%%%%% Function: computeSpectDistances.m
...
%%%%% 
%%%%% Output:
%%%%% datapoints - vector of datapoints
%%%%%
function [datapoints] = computeSpectDistances(channel_num, USEPROBETOVOCAL)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i=1:length(TRIGGER_TYPES)
    ...
    for i=1:length(targets) % loop through each unique trigger for a specific probeword
