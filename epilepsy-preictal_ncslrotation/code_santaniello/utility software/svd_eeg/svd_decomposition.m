...
% open the log file
fid0 = fopen(sprintf('%s/%s_log.dat',pathval,filename),'a');
%--------------------------------------------------------------------------
...
% % %                 V = eye(size(A,2));
            ...
            fid2 = fopen(sprintf('%s/svd_l_%s',pathval,listfile(position(k)).name(5:end)),'ab');
            fwrite(fid2,U(:),'single');
            fclose(fid2);
            
% % %             fid2 = fopen(sprintf('%s/svd_r_%s',pathval,listfile(position(k)).name(5:end)),'ab');
% % %             fwrite(fid2,V(:),'single');
% % %             fclose(fid2);
            
            fid2 = fopen(sprintf('%s/svd_v_%s',pathval,listfile(position(k)).name(5:end)),'ab');
...
fclose(fid0);
clear position k fid0 t nbytes locations
%--------------------------------------------------------------------------
